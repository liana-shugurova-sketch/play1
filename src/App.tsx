...
// --- ДАННЫЕ УРОВНЕЙ ---
// Все слова проверены — их можно собрать из букв уровня
const gameLevels: Level[] = [
  {
    letters: "КОРЬТО",
    words: ["КОТ", "РОТ", "ТОК", "РОК", "КРОТ", "КОРТ", "РОТЬ"]
  },
  {
    letters: "РАДУГА",
    words: ["РАД", "ДАР", "ГАД", "ДУГА", "РАДА", "АРГУ", "РУГА", "УДАР"]
  },
  {
    letters: "МОЛОКО",
  ...
  {
    letters: "ЛИМОНА",
    words: ["МИН", "НОМ", "ЛОМ", "МИЛ", "НАЛ", "МОЛ", "ЛИМОН", "МИНА", "НАЛИМ"]
  },
  {
    letters: "КОРОВА",
    words: ["КОРА", "КОР", "ВАР", "РАК", "ОКА", "КРА", "КОРОВА", "РОВ"]
  },
  {
    letters: "БАЛКОН",
    words: ["БАН", "БОК", "КОЛ", "ЛАК", "ЛОБ", "БАЛ", "КОЛА", "КЛОН", "БАЛКОН"]
  },
  {
    letters: "КАРТАС",
    words: ["КАР", "ТАР", "РАК", "САР", "КАРТ", "СТАР", "ТАРА", "КАРА", "АРКА", "РАСА", "КАРТА", "КАРАТ", "АСТРА"]
  }
];
